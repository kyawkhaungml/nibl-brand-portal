...
- comparisons: pick 1-3 when the question implies a binary or complementary choice. **leftPct + rightPct MUST always sum to exactly 100.** Pick options that are mutually exclusive or naturally complementary. Use this vocabulary when it fits:
  ...
  · Dinner 61% vs Lunch 39%
  You can also invent new binary splits relevant to the question, anchored in the brand data — as long as the two values sum to 100.
